...
# Human CMC->IP/TIP targets robot MCP-A-A->DIP/TIP.
THUMB_VECTOR_ROTATION_VECS = (
    (-2.407088, -0.207700, 0.107948),
    (-2.397136, 0.077015, 0.023815),
)
THUMB_VECTOR_SCALING = (1.423640, 1.360309)
THUMB_VECTOR_WEIGHTS = (1.0, 1.0)
